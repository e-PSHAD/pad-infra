...
$string['downloadcoursecontent_help'] = 'Ce réglage détermine si les contenus de séquence peuvent être téléchargés par les utilisateurs disposant de la capacité adéquate (par défaut ceux qui ont le rôle de stagiaire ou d\'intervenant).';
...
$string['gradetopassnotset'] = 'Cette séquence n\'a pas d\'évaluation pour passer. Une telle évaluation peut être indiquée dans l\'élément d\'évaluation de la séquence (configuration du livret des évaluations).';
...
$string['target:coursegradetopass'] = 'Stagiaires risquant de ne pas atteindre l\'évaluation minimale pour passer la séquence';
$string['target:coursegradetopass_help'] = 'Cette cible décrit si un stagiaire est considéré comme risquant de ne pas atteindre l\'évaluation minimale pour passer la séquence.';
...
$string['target:noteachingactivityinfo'] = 'Les séquences suivantes devant commencer les jours prochains risquent de ne pas pouvoir commencer parce qu\'elles n\'ont pas d\'intervenant ou de stagiaire inscrits.';
...
$string['targetlabelstudentgradetopassno'] = 'Stagiaire qui atteindra probablement l\'évaluation minimale pour passer la séquence.';
$string['targetlabelstudentgradetopassyes'] = 'Stagiaire risquant de ne pas atteindre l\'évaluation minimale pour passer la séquence.';
