...
$string['completionusegrade'] = 'Évaluation requise';
$string['completionusegrade_desc'] = 'Les stagiaires doivent recevoir une évaluation pour terminer cette activité';
$string['completionusegrade_help'] = 'Quand cette option est activée, les stagiaires doivent obtenir une évaluation de l\'activité pour la terminer. Des icônes de réussite ou d\'échec peuvent être affichées, si une évaluation minimale pour réussir a été spécifiée.';
...
$string['coursegrade'] = 'Évaluation de la séquence';
...
$string['err_nograde'] = 'Une évaluation minimale pour terminer la séquence avec succès n\'a pas été spécifiée. Pour activer ce type de critère, veuillez créer une évaluation minimale pour cette séquence.';
...
$string['graderequired'] = 'Évaluation de séquence requise';
...
$string['privacy:metadata:gradefinal'] = 'Évaluation finale reçue pour l\'achèvement de la séquence';
