...
$string['shufflequestions_help'] = 'Si ce réglage est activé, à chaque tentative du test, l\'ordre des questions dans cette section sera mélangé dans un ordre aléatoire différent. Ceci permet de rendre plus difficile le partage des réponses entre stagiaires, mais rend également plus difficile les discussions entre les stagiaires et le intervenant sur une question déterminée.';
$string['subnetnotice'] = 'Ce test a été configuré de façon à ne pouvoir être effectué que depuis certains ordinateurs. Votre ordinateur n\'est pas situé dans une sous-réseau autorisé. En tant que intervenant, vous pouvez toutefois le prévisualiser.';
