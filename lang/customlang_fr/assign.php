...
$string['gradingduedate_help'] = 'Le délai pour l\'évaluation des devoirs par le intervenant. Cette date est utilisée afin de prioriser les notifications du tableau de bord des intervenants.';
...
$string['modulename_help'] = 'Le module d\'activité devoir permet à un intervenant de communiquer aux participants des tâches, de récolter des travaux et de leur fournir feedbacks et notes. Les stagiaires peuvent remettre des travaux sous forme numérique (fichiers), par exemple des documents traitement de texte, feuilles de calcul, images, sons ou séquences vidéo. En complément ou en plus, le devoir peut demander aux stagiaires de saisir directement un texte. Un devoir peut aussi être utilisé pour indiquer aux stagiaires des tâches à effectuer dans le monde réel et ne nécessitant pas la remise de fichiers numériques. Les stagiaires peuvent remettre un devoir individuellement ou comme membres d\'un groupe. Lors de l\'évaluation des devoirs, les intervenants peuvent donner aux stagiaires des feedbacks, leur envoyer des fichiers : travaux annotés, documents avec commentaires ou feedbacks audio. Les devoirs peuvent être évalués au moyen d\'une note numérique, d\'un barème spécifique ou d\'une méthode avancée comme une grille d\'évaluation. Les notes définitives sont enregistrées dans le carnet de notes.';
$string['multipleteams_desc'] = 'Ce devoir nécessite la remise des travaux en groupes. Vous faites partie de plusieurs groupes. Pour pouvoir remettre un travail, vous devez ne faire partie que d\'un seul groupe. Veuillez contacter votre intervenant pour qu\'il change votre appartenance aux groupes.';
$string['noteam_desc'] = 'Ce devoir nécessite la remise des travaux en groupes. Vous ne faites partie d\'aucun groupe, et ne pouvez donc pas remettre de travail. Veuillez contacter votre intervenant pour qu\'il vous ajoute à un groupe.';
...
$string['sendnotifications_help'] = 'Si ce réglage est activé, les évaluateurs (en principe les intervenants) recevront un message chaque fois qu\'un stagiaire remet un travail pour ce devoir, qu\'il soit en avance, à temps ou en retard. La méthode d\'envoi des messages est configurable.';
