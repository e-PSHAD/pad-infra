...
$string['status_help'] = 'Ce réglage détermine si des utilisateurs peuvent être inscrits manuellement par un utilisateur disposant des permissions requises, par exemple un intervenant, via un lien dans l\'administration de la séquence.';
