...
$string['confighiddenuserfields'] = 'Veuillez sélectionner quelles informations vous désirez cacher aux autres utilisateurs de la séquence que les administrateurs/formateurs. Vous pourrez ainsi améliorer la protection des données des stagiaires. Il est possible de sélectionner plusieurs champs.';
...
$string['configrequestedteachername'] = 'Terme utilisé pour « formateur » dans les séquences demandées';
$string['configrequestedteachersname'] = 'Terme utilisé pour « formateurs » dans les séquences demandées';
$string['configsectionrequestedcourse'] = 'Demande de séquence';
$string['configshowsiteparticipantslist'] = 'Tous les stagiaires et les formateurs de la page d\'accueil de ce site seront affichés dans la liste des participants du site. Qui doit avoir les permissions requises pour voir cette liste des participants de la page d\'accueil ?';
...
$string['creatornewroleid'] = 'Rôle des créateurs de séquence dans les nouvelles séquences';
...
$string['profilevisible_help'] = '* caché - pour les données privées, uniquement visible pour les administrateurs * visible pour l\'utilisateur - pour les données personnelles, visibles par l\'utilisateur et les administrateurs * visible pour l\'utilisateur, les formateurs et les administrateurs - pour les données personnelles, visibles par l\'utilisateur, les formateurs et les administrateurs (sur le profil de séquence) * visible pour tous';
...
$string['showuseridentity_desc'] = 'Lors de la recherche ou de la sélection d\'utilisateurs, ainsi que lors de l\'affichage de listes d\'utilisateurs, ces champs peuvent être affichés en plus du nom complet. Ils ne sont montrés qu\'aux utilisateurs ayant la capacité moodle/site:viewuseridentity (par défaut, les gestionnaires et les formateurs). Ce réglage a plus de sens si vous imposez un ou deux champs obligatoires dans votre institution.';
